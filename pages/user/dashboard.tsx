        ...
        <div className='w-full md:w-2/3'>
            ...
            <div id="edvertsec" className='relative !visible !block h-screen'><h2 className='absolute top-[20%] left-14 text-3xl md:text-5xl font-bold'>Advertisement Panel</h2>
              ...
              <div className='relative grid grid-rows-4 grid-cols-4 grid-flow-col gap-4 justify-between px-6 top-5 left-5 min-h-[40%] rounded-3xl w-[96%]'>
                  <div className='row-span-2 col-span-2 flex py-8 px-5 w-full rounded-3xl bg-[#191919]  text-center text-4xl place-items-center'><FaSolarPanel className='h-24 w-24 col-span-1'></FaSolarPanel>Banner Advertisement<Button color='purple' size='lg' className='bg-gradient-to-br from-purple-500 to-purple-800 text-xl' onClick={() => {if (isCheckoutLoading) return;else goToBannerCheckout();}}>Buy</Button></div>
