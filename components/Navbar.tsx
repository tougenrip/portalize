...
import { useRouter } from "next/router";
 ...
 const Navbar = () => {
  ...
  return (
    ...
    <div className={`bg-[#151515] ${stickyClass} flex flex-row z-50 justify-between md:flex-row py-5 px-4 space-x-0 md:!space-x-32 w-screen md:px-20`}>
      <div className=" self-center">
        <Link href={`/`}><Image src='/img/logo_comp.webp' className="aspect-[218/38] h-auto w-auto" width={0} height={0} alt="Logo" unoptimized></Image></Link>
      </div>
