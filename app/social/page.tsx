...
import Container from "@/components/Socials/container";
import Footer from "@/components/Socials/footer";
import Logo from "@/components/Socials/logo";
import PostCard from "@/components/Socials/post-card";
import Stories from "@/components/Socials/stories";
import { Metadata } from "next";
import { redirect } from "next/navigation";
import React from "react";
import SuggestUserSide from "@/components/Socials/suggest-user-side";
import { getStories } from "@/_actions/stories.action";

export const metadata: Metadata = {
  metadataBase: new URL('http://localhost:3000/social'),
  title: "Portalize | Social",
  description:
