...
import CreateNewPostModal from "@/components/Socials/create-new-post-modal";
...
import {
  ...
  DropdownMenuTrigger,
} from "@/components/Socials/ui/dropdown-menu";
    ...
    <React.Fragment>
      ...
      <Link
        ...
        className={cn(
          ...
          pathname === "/social/search" && "font-bold"
        )}
      >
      ...
      <Link
        ...
        className={cn(
          "text-base font-light hover:bg-gray-100 py-2.5 px-3 rounded-md dark:hover:bg-gray-700",
          pathname === "/social/explore" && "font-bold"
        )}
      >
